...
- ввести email для администратора
- ввести пароль
- повторить пароль
...
**commit: `Урок 15: посмотрели другой способ регистрации модели`**
...
**commit: `Урок 24: добавили миксин с меню`**
...
Теперь наше приложение настроено для использования `django-allauth` с кастомными шаблонами и формой регистрации.
...
3. **Убран кастомный RegisterDoneView**
...
5. **Оптимизирован код в `urls.py`**
   - Теперь используется только `allauth`.
...
**commit: `Эпилог: обновили стили и улучшили шаблоны`**